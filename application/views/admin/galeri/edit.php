...
<div class="col-md-8">
	...
	<label>Judul Galeri</label>
		<input type="text" name="judul" class="form-control" placeholder="Judul Galeri" value="<?php echo $galeri->judul ?>" required>
	</div>
</div>
...
<div class="col-md-4">
	...
	<select class="form-control" name="posisi">
		...
		<option value="homepage" <?php if($galeri->posisi=="homepage") { echo  "selected"; } ?> >Homepage Slider</option>
	</select>
	</div>
</div>
...
<div class="col-md-6">
	...
	<div class="form-group form-group-lg">
		...
		<textarea  type="text" name="keterangan" class="form-control" placeholder="Isi Galeri"><?php echo $galeri->keterangan
		 ?></textarea>
	</div>
	</div>
