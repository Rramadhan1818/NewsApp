...
<div class="col-md-8">
	...
	<label>Judul Dokumen</label>
		<input type="text" name="judul" class="form-control" placeholder="Judul Dokumen" value="<?php echo set_value('judul') ?>" required>
	</div>
</div>
...
<div class="col-md-4">
	...
	<div class="form-group form-group-lg">
		...
		<textarea  type="text" name="isi" class="form-control" placeholder="Isi dokumen"><?php echo set_value('isi') ?></textarea>
	</div>
	</div>
